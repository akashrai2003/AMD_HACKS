...
if __name__ == "__main__":
    ...
    system_prompt = """
            You are an MCQ answering model.
...
Output:
{
  ...
  "answer": "C"
    ...
    responses, tl, gt = ans_agent.generate_response(messages, system_prompt= system_prompt, max_new_tokens=800, temperature=0.1, top_p=0.9, do_sample=True, tgps_show=True)
    print("Responses:")
